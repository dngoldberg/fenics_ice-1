...
python $RUN_DIR/run_inv.py ismipc_rc_1e6_rand.toml
python $RUN_DIR/run_forward.py ismipc_rc_1e6_rand.toml
python $RUN_DIR/run_eigendec_rand.py ismipc_rc_1e6_rand.toml
python $RUN_DIR/run_errorprop.py ismipc_rc_1e6_rand.toml
